...
class PeopleConnectConversation extends Model
{
    ...
    {
        return $this->hasMany(PeopleConnectSession::class, 'conversation_id');
    }

    public function messages(): HasMany
    {
        return $this->hasMany(PeopleConnectMessage::class, 'conversation_id');
    }

    public function topics(): HasMany
    {
        return $this->hasMany(PeopleConnectConversationTopic::class, 'conversation_id');
    }
}
