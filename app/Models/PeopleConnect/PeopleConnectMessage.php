...
class PeopleConnectMessage extends Model
{
    ...
    {
        return $this->belongsTo(PeopleConnectConversation::class, 'conversation_id');
    }

    public function session(): BelongsTo
    {
        return $this->belongsTo(PeopleConnectSession::class, 'session_id');
    }
    ...
    {
        return $this->belongsTo(PeopleConnectContextSnapshot::class, 'context_snapshot_id');
    }

    public function analysis(): HasOne
    {
        return $this->hasOne(PeopleConnectMessageAnalysis::class, 'message_id');
    }

    public function tags(): HasMany
    {
        return $this->hasMany(PeopleConnectMessageTag::class, 'message_id');
    }

    public function deliveryAttempts(): HasMany
    {
        return $this->hasMany(PeopleConnectDeliveryAttempt::class, 'message_id');
    }
}
