        ...
        <div class="card card-dashboard h-100" onclick="document.getElementById('logs-tab').click()">
            <div class="card-body p-3">
                ...
                <div class="d-flex justify-content-between align-items-end">
                    <div class="metric-value text-light" id="card-total-requests">0</div>
        ...
        <div class="card card-dashboard h-100">
            <div class="card-body p-3 text-center d-flex flex-column justify-content-center">
                ...
                <div class="position-relative d-inline-block mx-auto" style="width: 60px; height: 60px;">
                    ...
                    <div class="position-absolute top-50 start-50 translate-middle text-light fw-bold" style="font-size: 0.85rem;" id="card-success-rate-val">0%</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 col-lg-2">
        <div class="card card-dashboard h-100">
            <div class="card-body p-3 text-center d-flex flex-column justify-content-center">
                ...
                <div class="metric-value text-info mb-1" id="card-avg-latency">0<span class="fs-6 text-muted">ms</span></div>
    ...
    <div class="col-md-4 col-lg-2">
        <div class="card card-dashboard h-100" onclick="document.getElementById('budget-tab').click()">
            <div class="card-body p-3">
                ...
                <div class="metric-value text-light" id="card-total-cost">$0.00</div>
    ...
    <div class="col-md-4 col-lg-2">
        <div class="card card-dashboard h-100" onclick="document.getElementById('providers-tab').click()">
            <div class="card-body p-3 text-center d-flex flex-column justify-content-center">
                ...
                <div class="metric-value text-light" id="card-active-providers">0<span class="fs-6 text-muted">/{{ $providers->count() }}</span></div>
        ...
        <div class="card card-dashboard h-100">
            <div class="card-body p-3 text-center d-flex flex-column justify-content-center">
                ...
                <div class="position-relative d-inline-block mx-auto" style="width: 60px; height: 60px;">
                    ...
                    <div class="position-absolute top-50 start-50 translate-middle text-light fw-bold" style="font-size: 0.85rem;" id="card-cache-hit-val">0%</div>
                </div>
            </div>
        </div>
    </div>
